...
part of 'box_office_data_source.dart';
...
class _BoxOfficeDataSource implements BoxOfficeDataSource {
  _BoxOfficeDataSource(this._dio, {this.baseUrl, this.errorLogger});
